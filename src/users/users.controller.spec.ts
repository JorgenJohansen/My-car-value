...
describe('UsersController', () => {
  ...
  beforeEach(async () => {
    fakeUsersService = {
      ...
      find: (email: string) => {
        return Promise.resolve([{id: 5, email, password: 'asdf'} as User])
      },
      // remove: () => {},
      // update: () => {}
    }
  ...
  //   // await fakeUsersService.findOne = () => null;
  //   // await expect(controller.findUser('1')).rejects.toThrow(BadRequestException)
  // });
